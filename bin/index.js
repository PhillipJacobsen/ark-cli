...
// import ARK SDK libraries
const Crypto = require("@arkecosystem/crypto");    // https://www.npmjs.com/package/@arkecosystem/client
...
(async () => {
    ...
    // customize yargs 
    yargs.scriptName("ark-cli")   // without this then --help shows filename [command] instead of app name
 ...
 Command: Verify message signature
    ...
    */
    yargs.command({
        command: "tx-ipfs",
        describe: "Send IPFS transaction",
        builder: {
            hash: {
                describe: "IPFS Hash",
                demandOption: true,
